...
import com.app.neomu_kotlin.common.util.DatabaseUtil
...
open class FirebaseUtil {
    ...
    fun setFirebaseRecyclerOption(): FirebaseRecyclerOptions.Builder<Post> {
        val postQuery = DatabaseUtil().getPostQuery()
